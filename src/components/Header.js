...
const Header = ()=>{
	...
	return(
		<>
			...
			<Container>
			  <Navbar.Brand href="#home" className="text-info">My-Portfolio</Navbar.Brand>
			  <Navbar.Toggle aria-controls="basic-navbar-nav" />
			  
			  	<Navbar.Collapse id="basic-navbar-nav">
			    	<Nav className="ml-auto">
			    		<NavItem>
			    			<NavLink exact to="/my-Portfolio" className="nav_link" activeClassName="selected">Home</NavLink>
			    		</NavItem>
			    		<NavItem>
